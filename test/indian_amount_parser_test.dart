...
void main() {
  group('IndianAmountParser', () {
    test('parses supported Indian SMS money formats', () {
      expect(IndianAmountParser.extract('Paid \u20B9299 for service.'), 299);
      expect(IndianAmountParser.extract('Amount billed: \u20B9 1,499 today.'),
          1499);
      expect(IndianAmountParser.extract('Rs 299 debited.'), 299);
      expect(IndianAmountParser.extract('Rs.299 charged.'), 299);
      expect(IndianAmountParser.extract('INR 149.00 processed.'), 149);
